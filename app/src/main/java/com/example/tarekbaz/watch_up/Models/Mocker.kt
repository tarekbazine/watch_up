...
//    var favCinemaList: List<Cinema> = listOf()
    ...
    init {
        ...
        actorList = listOf(
                Person(1, "Aaron Eckhart", R.drawable.persons1, date, 1,"Aaron Eckhart was born on March 12, 1968 in Cupertino, California, USA as Aaron Edward Eckhart. He is an actor and producer, known for The Dark Knight (2008), Thank You for Smoking (2005) and In the Company of Men (1997).","Boston","img", listOf(), 0.8, listOf()),
                Person(2,"Aaron Paul", R.drawable.persons1, date, 1,"Aaron Paul was born Aaron Paul Sturtevant in Emmett, Idaho, to Darla (Haynes) and Robert Sturtevant, a retired Baptist minister. While growing up, Paul took part in church programs, and performed in plays.", "Boston","img",listOf(), 0.8, listOf()),
                Person(3,"Adam Sandler", R.drawable.persons1, date, 1,"Adam Richard Sandler was born September 9, 1966 in Brooklyn, New York, to Judith (Levine), a teacher at a nursery school, and Stanley Alan Sandler, an electrical engineer. He is of Russian Jewish descent", "Boston","img",listOf(), 0.8, listOf()),
//                Person("Salsa Bilato", R.drawable.persons1, "1970-03-01", "Sandler was born September 9, 1966 in Brooklyn, New York, to Judith (Levine), a teacher at a nursery school, and Stanley Ala", listOf(), 0.8, listOf()),
                Person(4,"Adrien Brody", R.drawable.persons1, date, 1,"Adrien Nicholas Brody was born in Woodhaven, Queens, New York, the only child of retired history professor Elliot Brody and Hungarian-born photographer Sylvia Plachy. ","Boston","img", listOf(), 0.8, listOf()),
                Person(5,"Aidan Gillen", R.drawable.persons1, date, 1,"Aidan Gillen is an Irish actor. He is best known for portraying Petyr \"Littlefinger\" Baelish in the HBO episodes Game of Thrones (2011), CIA operative Bill Wilson in The Dark Knight Rises (2012), Stuart Alan Jones in the Channel 4 episodes Queer as Folk (1999).","Boston","img", listOf(), 0.8, listOf()),
                Person(6,"Al Pacino", R.drawable.persons1, date, 1,"One of the greatest actors in all of film history, Al Pacino established himself during one of film's greatest decades, the 1970s, and has become an enduring and iconic figure in the world of American movies.", "Boston","img",listOf(), 0.8, listOf()),
                Person(7,"Alan Arkin", R.drawable.persons1, date, 1,"Alan Arkin is an Academy Award-winning American actor who is also an acclaimed director, producer, author, singer and composer.","Boston","img", listOf(), 0.8, listOf()),
                Person(8,"Mike bill", R.drawable.persons1, date, 1,"Sandler was born September 9, 1966 in Brooklyn, New York, to Judith (Levine), a teacher at a nursery school, and Stanley Ala","Boston","img", listOf(), 0.3, listOf()),
                Person(9,"Alan Rickman", R.drawable.persons1, date,1, "Alan Rickman was born on a council estate in Acton, West London, to Margaret Doreen Rose (Bartlett) and Bernard Rickman, who worked at a factory. He had English, Irish, and Welsh ancestry. Alan had an older brother David.","Boston","img", listOf(), 0.8, listOf()),
                Person(10,"Alan Tudyk", R.drawable.persons1, date, 1,"Alan Tudyk was born in El Paso, Texas, and grew up in Plano, where he attended Plano Sr. High. In 1990, he went on to study drama at Lon Morris Jr. College. While there, he was awarded the Academic Excellence Award for Drama.","Boston","img", listOf(), 0.8, listOf()),
                Person(11,"Alec Baldwin", R.drawable.persons1, date, 1,"Raven-haired, suavely handsome and prolific actor Alec Baldwin was born on April 3, 1958 in Massapequa, New York, and is the oldest, and easily the best-known, of the four Baldwin brothers in the acting business (the others are Stephen Baldwin, William Baldwin and Daniel Baldwin).","Boston","img", listOf(), 0.8, listOf())
        )
...
//        directorList = listOf(
//                Person("Aaron Taylor-Johnson", R.drawable.persons1r, "1944-03-07", "He was born Aaron Perry Johnson in High Wycombe, Buckinghamshire, to Sarah and Robert Johnson, a civil engineer. He has a sister, Gemma Johnson, who had a small role in his movie Tom & Thomas (2002)", listOf(), 0.8, listOf()),
//                Person("Steven Spielberg", R.drawable.persons1r, "1944-05-03", "One of the most influential personalities in the history of cinema, Steven Spielberg is Hollywood's best known director and one of the wealthiest filmmakers in the world. He has an extraordinary number of commercially successful and critically acclaimed credits to his name, either as a director, ...", listOf(), 0.8, listOf()),
//                Person("Aidan Gillen", R.drawable.persons1, "1946-10-25", "Aidan Gillen is an Irish actor. He is best known for portraying Petyr \"Littlefinger\" Baelish in the HBO episodes Game of Thrones (2011), CIA operative Bill Wilson in The Dark Knight Rises (2012), Stuart Alan Jones in the Channel 4 episodes Queer as Folk (1999).", listOf(), 0.8, listOf()),
//                Person("Martin Scorsese", R.drawable.persons1r, "1950-01-16", "Martin Charles Scorsese was born on November 17, 1942 in Queens, New York City, to Catherine Scorsese (née Cappa) and Charles Scorsese, who both worked in Manhattan's garment district, and whose families both came from Palermo, Sicily. He was raised in the neighborhood of Little Italy, which later ...", listOf(), 0.8, listOf()),
//                Person("Ridley Scott", R.drawable.persons1r, "1951-07-31", "Described by film producer Michael Deeley as \"the very best eye in the business\", director Ridley Scott was born on November 30, 1937 in South Shields, Tyne and Wear (then County Durham). His father was an officer in the Royal Engineers and the family followed him as his career posted him ...", listOf(), 0.8, listOf()),
//                Person("John Woo", R.drawable.persons1r, "1953-09-11", "Best known for his cerebral, often nonlinear storytelling, acclaimed writer-director Christopher Nolan was born on July 30, 1970 in London, England. Over the course of 15 years of filmmaking, Nolan has gone from low-budget independent seasons to working on some of the biggest blockbusters ever made.", listOf(), 0.8, listOf()),
//                Person("Adrien Brody", R.drawable.persons1, "1955-07-06", "Adrien Nicholas Brody was born in Woodhaven, Queens, New York, the only child of retired history professor Elliot Brody and Hungarian-born photographer Sylvia Plachy. ", listOf(), 0.8, listOf()),
//                Person("Tim Burton", R.drawable.persons1r, "1955-09-22", "Timothy Walter Burton was born in Burbank, California, to Jean Rae (Erickson), who owned a cat-themed gift shop, and William Reed Burton, who worked for the Burbank Park and Recreation Department. He spent most of his childhood as a recluse, drawing cartoons, and watching old movies (he was ...", listOf(), 0.8, listOf()),
//                Person("Clint Eastwood", R.drawable.persons1r, "1955-10-14", "Clint Eastwood was born May 31, 1930 in San Francisco, the son of Clinton Eastwood Sr., a manufacturing executive for Georgia-Pacific Corporation, and Ruth Wood, a housewife turned IBM operator. He had a comfortable, middle-class upbringing in nearby Piedmont. At school Clint took interest in music...", listOf(), 0.8, listOf()),
//                Person("David Fincher", R.drawable.persons1r, "1956-03-26", "David Fincher was born in 1962 in Denver, Colorado, and was raised in Marin County, California. When he was 18 years old he went to work for John Korty at Korty Films in Mill Valley.", listOf(), 0.8, listOf())
//        )
